...
*
*/
extern int token_create_parameters(char *url_data,char *client_id_data,char *client_secret_data,char *request_content);
...
*
*/
extern int bd_get_token(char* url,char *access_token);
...
*返回0说明成功;返回-1说明失败
*/
extern int get_bd_tokenaccess(char *token_path);
