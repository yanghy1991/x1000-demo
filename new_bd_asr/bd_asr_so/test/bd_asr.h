...
*
*/
extern int asr_http_post(char *host_data,char *wav_path,char* format_data,char *token_data,char *cuid,char *result,char *err_msg,int *error_no);


extern int bd_asr(char *file_path,char *audio_path,char *audio_format,char *cuid,char *result,char *err_msg,int *error_no);
